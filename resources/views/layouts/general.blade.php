...
<body background="{{asset('/img/app/fondo.jpg')}}">
...
<script src="{{asset('/plugins/validate/dist/jquery.validate.js')}}"></script>
<script src="{{asset('/plugins/validate/dist/additional-methods.js')}}"></script>
